    ...
    <div>
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 text-lg text-white/80">
              Get involved with one of Penn State&apos;s most vibrant cultural
              organizations.
            </p>
          </div>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <SectionHeading>Why Join SASA?</SectionHeading>
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {[
              {
                title: "Cultural Events",
                desc: "Experience vibrant cultural shows, Diwali celebrations, Holi festivals, and more.",
              },
              {
                title: "Community",
                desc: "Meet fellow students who share your heritage and make lifelong friendships.",
              },
              {
                title: "Leadership",
                desc: "Develop leadership skills by joining committees and organizing events.",
              },
              {
                title: "THON",
                desc: "Be part of our THON efforts — Penn State's largest student-run philanthropy.",
              },
            ].map((item) => (
              <div
                key={item.title}
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 text-center">
            <p className="text-sm text-sasa-neutral-500">Follow us on social media:</p>
